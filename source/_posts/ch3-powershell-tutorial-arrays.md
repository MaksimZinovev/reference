...
```powershell
$myArrayList = [System.Collections.ArrayList]@()
$myArrayList.Add("item1")          # => 0

$myList = New-Object System.Collections.ArrayList
$myList.GetType()                  # => System.Collections.ArrayList
$myList.IsFixedSize                # => False
...
echo ""
echo "remove itemC:"
$myList.Remove("itemC")            # removes itemC (first occurrence)
$myList                              # => itemA, itemB, itemC

echo ""
echo "remove range:"
$myList.RemoveRange(0, 1)          # removes 1 item starting at index 0
$myList                              # => itemB, itemC
```
